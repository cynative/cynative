...
| Credential downscoping | — · user tokens can't be downscoped at runtime (a GitHub App path is tracked in [#209](https://github.com/cynative/cynative/issues/209)) |
