...
Role assignments: `GET /subscriptions/{subscriptionId}/providers/Microsoft.Authorization/roleAssignments` on `management.azure.com`; one resource group's assignments at `GET /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Authorization/roleAssignments`; one management group's role assignments at `GET /providers/Microsoft.Management/managementGroups/{groupId}/providers/Microsoft.Authorization/roleAssignments`.
