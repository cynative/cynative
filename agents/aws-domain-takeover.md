...
For the shadow resource pattern, report only bucket names that the account's own service configurations reference and that answered 404. Do not enumerate candidate names, and do not report a 403 as a takeover opportunity.
