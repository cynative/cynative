...
Report the principals outside this account that a repository resource policy admits, since publishing rights into a repository this account builds from are a path into the account, and report the functions and execution roles behind each out-of-organization layer.
